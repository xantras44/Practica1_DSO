...
int main()
{
	...
	printf("\nPRUEBA1 escribir con puntero al final\n");
	...
	printf("\nPRUEBA2 mkFS mayor y mkFS menor\n");
	tamano = 2000;
	ret = mkFS(tamano);
	if (ret != -1)
	{
	...
	printf("\nPRUEBA4 createFileError y removeFileError\n");
	mkFS(DEV_SIZE);
	...
	printf("\nPRUEBA5 openFileError y closeFileError\n");
	mkFS(DEV_SIZE);
	mountFS();
	...
	printf("\nPRUEBA6 readFileError y writeFileError\n");
	mkFS(DEV_SIZE);
	mountFS();
	...
	printf("\nPRUEBA8 checkFileError e includeIntegrityError\n");
	mkFS(DEV_SIZE);
	mountFS();
	...
	printf("\nPRUEBA9 openFileIntegrityError y closeFileIntegrityError\n");
	mkFS(DEV_SIZE);
	mountFS();
	...
	printf("\nPRUEBA10 createLnError y removeLnError\n");
	mkFS(DEV_SIZE);
	mountFS();
